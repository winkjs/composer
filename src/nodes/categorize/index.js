/**
 * @fileoverview Entry point for categorize node.
 *
 * Re-exports all lifecycle functions (init, update, publishTo, reset, recompute),
 * shared control signals (disable, enable, pause, unpause), and introspection metadata.
 */
