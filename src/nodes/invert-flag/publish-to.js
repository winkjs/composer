/**
 * @fileoverview Publish function for invertFlag node.
 *
 * Copies the inverted flag to the output message, or propagates
...
const publishTo = function ( state, msg ) {
    ...
    msg[ state.stats.inverted.storeAs ] = state.inverted;
}; // publishTo()
