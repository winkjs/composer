/**
 * @fileoverview Barrel module for the es-correlation node. Re-exports lifecycle
 * methods (init, update, reset, recompute, publishTo), shared control signals
 * (disable, enable, pause, unpause), and all introspection metadata.
 */
// nodes/es-correlation/index.js
