/**
 * @fileoverview Barrel module for the es-pairwise-correlation node. Re-exports
 * lifecycle methods (init, update, reset, recompute, publishTo), shared control
 * signals (disable, enable, pause, unpause), and all introspection metadata.
 */
// nodes/es-pairwise-correlation/index.js
