...
- [`hello-flow.js`](hello-flow.js) — the whole program. The same flow
  appears in the repository [Quick Start](https://github.com/winkjs/composer/blob/0.5.1/README.md#quick-start).
- [`data/pump-temps.csv`](data/pump-temps.csv) — the replayed feed:
  two columns, a pump id and a motor temperature.

The [handbook](https://github.com/winkjs/composer/blob/0.5.1/docs/handbook/index.md)
